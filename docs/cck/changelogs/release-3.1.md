...
- The video player can now be set up for room-scale audio experiences
- A room-scale video player prefab was added to the prefabs directory

### Additional hints

- Some of the new features require a game update to function. You can already prepare content and new features become available with the upcoming stable update which is expected to release within the next days.