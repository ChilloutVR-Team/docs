...
#### On Pointer Enter
Triggered whenever a player's [pointer](cvr-pointer.md) enters the trigger.

#### On Pointer Exit
Triggered whenever a player's [pointer](cvr-pointer.md) exits the trigger.

!!! info "Pointers"
    These triggers are compatible with both manual [pointers](cvr-pointer.md) and [Auto-Generated Avatar Pointers](../avatar/autogenerated-pointers.md).
